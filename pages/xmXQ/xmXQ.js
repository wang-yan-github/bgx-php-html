...
Page({
  ...
  lianxi: function() {
    //跳转到聊天界面
    let infoId = this.data.xmInfo.bsid;
    let fbfName = this.data.xmInfo.fbfName;
    ...
    let type_ = 1;
    wx.navigateTo({
      url: '../xiaoxi/pageXiaoxi?to_id=' + infoId + '&to_type=' + type_ + '&duty_name=' + fbfName
    })
  ...
  fujiantap: function(e) {
    ...
    let zhi = e.currentTarget.dataset.zhi;
